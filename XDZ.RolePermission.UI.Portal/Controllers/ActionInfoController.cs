...
namespace XDZ.RolePermission.UI.Portal.Controllers
{
    ...
    {
        short delFlagNormal = (short)XDZ.RolePermission.Model.Enum.DelFlagEnum.Normal;//直接放在类下，以便公用
        ...
        public ActionResult Index()
        {
            //int i = 0;
            //int b = 2 / i;
            //return Content("HHH");// 能把这个运行时错误写入日志
        ...
        {
            //actionInfo.ActionName = Request["ActionName"];//由于前台的name属性值与后台的属性值相同，具有自动装备功能，不需要赋值即可，当然你赋值也可一定，剩下的Pwd等属性值就不赋值了。
